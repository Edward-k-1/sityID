...
!function (e, t, n) {
    ...
    function i(e) {
        ...
        function i(e, o, i, l, d, s, c, m, u, g, f) {
            function p(e) {
                b(e)
            }
            ...
            function h(e, t, n, o) {
                if (o) {
                    if (o.mdHtmlContent = o.htmlContent || n.htmlContent || "", o.mdTextContent = o.textContent || n.textContent || o.content || n.content || "", o.mdHtmlContent && !g.has("$sanitize"))throw Error("The ngSanitize module must be loaded in order to use htmlContent.");
            ...
            function C(e, n, o, r) {
                ...
                if (t.element(s[0].body).addClass("md-dialog-is-showing"), o.contentElement) {
                    var d = o.contentElement;
                    t.isString(d) ? (d = document.querySelector(d), o.elementInsertionSibling = d.nextElementSibling, o.elementInsertionParent = d.parentNode) : (d = d[0] || d, document.contains(d) && (o.elementInsertionSibling = d.nextElementSibling, o.elementInsertionParent = d.parentNode)), o.elementInsertionEntry = d, n = t.element(d)
                }
                ...
                return y(o), E(c, o), $(e, n, o), k(n, o), x(n, o).then(function () {
                    S(n, o), a(), l()
                })
            }
            ...
            function v(e, n, o) {
                ...
                function d() {
                    t.element(s[0].body).removeClass("md-dialog-is-showing"), o.contentElement ? l() : n.remove(), o.$destroy || o.origin.focus()
                }
            ...
            function b(e) {
                if (!e.theme && (e.theme = f.defaultTheme(), e.targetEvent && e.targetEvent.target)) {
            ...
            function y(e) {
                ...
                function i(e, n) {
                    return t.isString(e) && (e = s[0].querySelector(e)), t.element(e || n)
                }
            ...
            function k(n, o) {
                ...
                if (o.escapeToClose) {
                    var m = o.parent, u = function (e) {
                        e.keyCode === l.KEY_CODE.ESCAPE && (e.stopPropagation(), e.preventDefault(), s())
                    };
                    n.on("keydown", u), m.on("keydown", u), d.push(function () {
                        n.off("keydown", u), m.off("keydown", u)
                    })
                }
                if (r.on("resize", a), d.push(function () {
                        r.off("resize", a)
                    }), o.clickOutsideToClose) {
                    var g, f = n, p = function (e) {
                        g = e.target
                    }, h = function (e) {
                        g === f[0] && e.target === f[0] && (e.stopPropagation(), e.preventDefault(), s())
                    };
            ...
            function $(e, t, n) {
                n.disableParentScroll && (n.restoreScroll = i.disableScrollAround(t, n.parent)), n.hasBackdrop && (n.backdrop = i.createBackdrop(e, "md-dialog-backdrop md-opaque"), d.enter(n.backdrop, n.parent)), n.hideBackdrop = function (e) {
                    n.backdrop && (e ? n.backdrop.remove() : d.leave(n.backdrop)), n.disableParentScroll && (n.restoreScroll(), delete n.restoreScroll), n.hideBackdrop = null
                }
            }

            function E(e, t) {
                var n = "alert" === t.$type ? "alertdialog" : "dialog", l = e.find("md-dialog-content"), d = e.attr("id"), s = "dialogContent_" + (d || i.nextUid());
                e.attr({
                    role: n,
                    tabIndex: "-1"
                }), 0 === l.length && (l = e, d && (s = d)), l.attr("id", s), e.attr("aria-describedby", s), t.ariaLabel ? o.expect(e, "aria-label", t.ariaLabel) : o.expectAsync(e, "aria-label", function () {
                    var e = l.text().split(/\s+/);
            ...
            function S(e, t) {
                function n(e) {
                    for (; e.parentNode;) {
                        ...
                        for (var t = e.parentNode.children, i = 0; i < t.length; i++)e === t[i] || I(t[i], ["SCRIPT", "STYLE"]) || t[i].setAttribute("aria-hidden", o);
                        n(e = e.parentNode)
                    }
                }
            ...
            function T(e, t) {
                var n = "fixed" == c.getComputedStyle(s[0].body).position, o = t.backdrop ? c.getComputedStyle(t.backdrop[0]) : null, r = o ? Math.min(s[0].body.clientHeight, Math.ceil(Math.abs(parseInt(o.height, 10)))) : 0, a = {
                    top: e.css("top"),
                    height: e.css("height")
                };
                return e.css({
            ...
            function x(e, t) {
                t.parent.append(e), t.reverseContainerStretch = T(e, t);
                ...
                }, l = o.toTransformCss(r(n, t.openFrom || t.origin)), d = o.toTransformCss("");
                return t.fullscreen && n.addClass("md-dialog-fullscreen"), o.translate3d(n, l, d, a).then(function (e) {
                    return t.reverseAnimate = function () {
                        ...
                        }, l = d, d = o.toTransformCss(r(n, t.closeTo)), o.translate3d(n, l, d, a)) : e(d = o.toTransformCss(r(n, t.origin)))
                    }, t.clearAnimate = function () {
                        return delete t.clearAnimate, o.translate3d(n, d, o.toTransformCss(""), {})
                    }, !0
                })
            }
    ...
    t.module("material.components.dialog", ["material.core", "material.components.backdrop"]).directive("mdDialog", o).provider("$mdDialog", i), o.$inject = ["$$rAF", "$mdTheming", "$mdDialog"], i.$inject = ["$$interimElementProvider"]
