/**
 * Created by walex on 26.12.16.
 */
app.service('VehiclesStatesRestService', ['$resource','AuthService', function ($resource,AuthService) {
    ...
    {
        this.updateToken();
        return $resource('/v1/vehicles-states/:id', null,
